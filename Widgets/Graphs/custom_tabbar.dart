                            ...
                            child: Column(
                              ...
                              children:const [
                                Align(
                                  ...
                                  child: FittedBox(
                                    child: Text('Ver DisAppointed',textAlign: TextAlign.end,),
                                  ),
                                ),
                                Align(
                                  alignment: Alignment.centerRight,
                                  child: FittedBox(
                                    child: Text('DisAppointed',textAlign: TextAlign.end,),
                                  ),
                                ),
                                Align(
                                  alignment: Alignment.centerRight,
                                  child: FittedBox(
                                    child: Text('Normal',textAlign: TextAlign.end,),
                                  ),
                                ),
                                Align(
                                  alignment: Alignment.centerRight,
                                  child: FittedBox(
                                    child: Text('Happy',textAlign: TextAlign.end,),
                                  ),
                                ),
                                Align(
                                  alignment: Alignment.centerRight,
                                  child: FittedBox(
                                    child: Text('Ver Happy',textAlign: TextAlign.end,),
                                  ),
                                ),
...
final mood = [
  ...
  DailyMood(DateTime.utc(2022,3,15),5),
